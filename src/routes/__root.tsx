...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TruthSense AI — Verify medical AI answers" },
      {
        name: "description",
        content:
          "TruthSense AI fact-checks healthcare answers from AI models against clinical evidence.",
      },
      { name: "author", content: "TruthSense AI" },
